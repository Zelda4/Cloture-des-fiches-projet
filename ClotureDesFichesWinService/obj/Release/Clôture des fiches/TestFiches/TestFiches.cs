...
namespace TestFiches
{
    ...
    public class TestFiches
    {
        ...
        public void testGetMoisPrecedent()
        {
            ...
            Assert.AreEqual(numMoisPrecedent, GestionDates.getMoisPrecedent(), "Le mois précédent par rapport à la date actuelle n'est pas le bon.");
        }
        ...
        public void testGetMoisPrecedentSurcharge()
        {
            ...
            Assert.AreEqual(numMoisPrecedent, GestionDates.getMoisPrecedent(uneDate), "Le mois précédent par rapport à la date entrée n'est pas le bon.");
        }
        ...
        public void testGetMoisSuivant()
        {
            ...
            Assert.AreEqual(numMoisSuivant, GestionDates.getMoisSuivant(), "Le mois suivant par rapport à la date actuelle n'est pas le bon.");
        }
        ...
        public void testGetMoisSuivantSurcharge()
        {
            ...
            Assert.AreEqual(numMoisSuivant, GestionDates.getMoisSuivant(uneDate), "Le mois suivant par rapport à la date entrée n'est pas le bon.");
        }
